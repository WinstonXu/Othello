...
public class Anastasia extends OthelloPlayer {
    ...
    //Gives preference to the corner squares
    ...
    //Stability = calculating whether it is likely that those pieces can be captured
    ...
    //Checks how many new open spaces are created by placing a piece:
    //In general, try to minimize amount of frontier space-more oppurtunities for opponent
    ...
    //Unless that color already has a piece in the corner, avoid the 3 squares adjacent to them
    ...
    //If corner is available, take it, otherwise go through heuristics
